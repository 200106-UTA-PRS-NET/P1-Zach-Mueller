...
namespace PizzaWebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IOrderRepository<Pizza_Data.Models.Orders>, OrderRepository>();
            services.AddTransient<IStoreRepository<Pizza_Data.Models.Store>, StoreRepository>();
            services.AddTransient<ICompletedOrderRepository<Pizza_Data.Models.CompletedOrders>, CompletedOrderRepository>();
